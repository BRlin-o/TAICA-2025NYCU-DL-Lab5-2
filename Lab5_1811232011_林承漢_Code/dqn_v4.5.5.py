...
# --- CustomFrameStack wrapper for environments without built-in FrameStack
from gymnasium import Wrapper, spaces
from collections import deque

class CustomFrameStack(Wrapper):
    """
    Custom frame stacking wrapper for environments without built-in FrameStack.
    Stacks the last k observations in a LazyFrames container to save memory.
    """
