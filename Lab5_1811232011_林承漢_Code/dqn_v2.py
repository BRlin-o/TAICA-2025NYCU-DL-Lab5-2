...
if __name__ == "__main__":
    ...
    parser.add_argument("--env-name", type=str, default="CartPole-v1", help="環境名稱") # ["CartPole-v1", "ALE/Pong-v5"]
    parser.add_argument("--save-dir", type=str, default="./results")
    parser.add_argument("--wandb-run-name", type=str, default="cartpole-run")
    parser.add_argument("--wandb-project", type=str, default="DLP-Lab5-DQN-CartPole(T1)")
